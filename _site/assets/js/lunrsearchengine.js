...
var documents = [{
    ...
    "title": "404",
    "body": "404 Page does not exist!Go Home? Home "
    }, {
    "id": 1,
    ...
    "id": 3,
    "url": "http://localhost:4000/mediumish-theme-jekyll/themes-slate/hiking_blog/",
    "title": "Blog",
    "body": "Latest Posts Menu:           Jun 12, 2018    Powerful things you can do with the Markdown editor            Jun 12, 2018    The first mass-produced book to deviate from a rectilinear format            Jun 12, 2018    Education must also train one for quick, resolute and effective thinking.             Jun 12, 2018    Accumulated experience of social living            May 12, 2018    About Bundler            Jan 12, 2018    We all wait for summer            Jan 12, 2018    Tree of Codes            Jan 12, 2018    Red Riding Hood            Jan 12, 2018    Press and education            Jan 12, 2018    Options for creating a new site with Jekyll            Jan 12, 2018    Never stopped worrying or loving the bomb            Jan 12, 2018    External Featured Image            Jan 11, 2018    Let's test spoilers            Jan 11, 2018    Inception Movie                                                                  &lt;/html&gt; "
    }, {
    "id": 4,
    ...
    "id": 5,
    "url": "http://localhost:4000/mediumish-theme-jekyll/themes-slate/post/",
    "title": "",
    "body": "{{ page. title }}{{ page. date | date_to_string }} - {{ page. author }} {{ content }} "
    }, {
    "id": 6,
    "url": "http://localhost:4000/mediumish-theme-jekyll/themes-slate/template/",
    "title": "",
    "body": "Text can be bold, italic, or strikethrough. Link to another page. There should be whitespace between paragraphs. There should be whitespace between paragraphs. We recommend including a README, or a file with information about your project. Header 1This is a normal paragraph following a header. GitHub is a code hosting platform for version control and collaboration. It lets you and others work together on projects from anywhere. Header 2:  This is a blockquote following a header.  When something is important enough, you do it even if the odds are not in your favor. Header 3: 12345// Javascript code with syntax highlighting. var fun = function lang(l) { dateformat. i18n = require('. /lang/' + l) return true;}1234# Ruby code with syntax highlightingGitHubPages::Dependencies. gems. each do |gem, version| s. add_dependency(gem,  = #{version} )endHeader 4:  This is an unordered list following a header.  This is an unordered list following a header.  This is an unordered list following a header. Header 5 This is an ordered list following a header.  This is an ordered list following a header.  This is an ordered list following a header. Header 6      head1   head two   three         ok   good swedish fish   nice       out of stock   good and plenty   nice       ok   good oreos   hmm       ok   good zoute drop   yumm   There’s a horizontal rule below this. : Here is an unordered list::  Item foo Item bar Item baz Item zipAnd an ordered list::  Item one Item two Item three Item fourAnd a nested list::  level 1 item     level 2 item   level 2 item         level 3 item     level 3 item           level 1 item     level 2 item   level 2 item   level 2 item    level 1 item     level 2 item   level 2 item    level 1 itemSmall image: Large image: Definition lists can be used with HTML syntax. : NameGodzillaBorn1952BirthplaceJapanColorGreen1Long, single-line code blocks should not wrap. They should horizontally scroll if they are too long. This line should be long enough to demonstrate this. 1The final element. "
    }, {
    "id": 7,
